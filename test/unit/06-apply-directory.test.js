...
describe("apply directory of patches step", () => {
    beforeEach(() => {
    ...
    test("should apply a directory of patches in alphabetical order", () => {
        ...
        fs.writeFileSync(path.join(patchesDir, "01-p1.patch"), patchContent1, "utf8");
        fs.writeFileSync(path.join(patchesDir, "02-p2.patch"), patchContent2, "utf8");

        const out = runCLI(`apply "${patchesDir}"`);
